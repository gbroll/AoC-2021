...
{
    auto parse_dur = chrono::duration_cast<chrono::microseconds>(time_stamps[1] - time_stamps[0]);
    auto solve_dur = chrono::duration_cast<chrono::microseconds>(time_stamps[2] - time_stamps[1]);
    auto total_dur = chrono::duration_cast<chrono::microseconds>(time_stamps[2] - time_stamps[0]);
